...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 12 Septembre 2017 à 15:51
...
INSERT INTO `user` (`id_user`, `nom`, `prenom`, `mail`, `id_formation`, `id_role`) VALUES
...
ALTER TABLE `user`
  ...
  ADD KEY `formation` (`id_formation`);
...
ALTER TABLE `user`
  ...
  ADD CONSTRAINT `user_ibfk_2` FOREIGN KEY (`id_formation`) REFERENCES `formations` (`id_formation`) ON DELETE CASCADE ON UPDATE CASCADE;
